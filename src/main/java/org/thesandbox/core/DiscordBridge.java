    ...
    private final class ServerActivityListener implements Listener {
        ...
        public void onJoin(PlayerJoinEvent e) {
            ...
            if (!vanish_status) {
                ...
                sendGenericEmbed("joined the game while vanished", new Color(0,0,0,255), p.getName(),playerHeadUrl(p) , "Logs");
            }
        }
        ...
        public void onQuit(PlayerQuitEvent e) {
            ...
            if (!vanish_status) {
                ...
                sendGenericEmbed("left the game while vanished", new Color(0,0,0,255), p.getName(),playerHeadUrl(p) , "Logs");
            }
        }
